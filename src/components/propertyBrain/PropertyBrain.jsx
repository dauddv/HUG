...
const PropertyBrain = () => {
  return (
    <div>
        ...
        <div className="PropertyBrain">
            <div className="PropertyBrainHeader">
                <div className="PropertyBrainHeaderrow1">
                    <div className="PBHeaderrow1Inner">
                      <h2>My Property Brain</h2>
                      <p className="mont">27414 Waynesborough Lane, Valencia CA 91354</p>
                      <div className="PBHeaderrow1Progressbar">
                        <h4>54% Trained</h4>
                      </div>
                    </div>
                </div>
                <div className="PropertyBrainHeaderrow2">
                  ...
                  <div className="PBHeaderrow2Bedroominfo">

                    <div className="PBHeaderrow2BRnfologonumAndText">
                    <div className="PBHeaderrow2BRnfologoAndnum">
                      <div className="PBHeaderrow2BRnfologo"><IoBedOutline /></div>
                      <div className="PBHeaderrow2BRnfonum"><h5>3</h5></div>
                    </div>
                    <div className="PBHeaderrow2BRnfoText"><p className="publicSan">Bedrooms</p></div>
                    </div>

                    <div className="PBHeaderrow2BRnfologonumAndText">
                    <div className="PBHeaderrow2BRnfologoAndnum">
                      <div className="PBHeaderrow2BRnfologo"><FaShower /></div>
                      <div className="PBHeaderrow2BRnfonum"><h5>2</h5></div>
                    </div>
                    <div className="PBHeaderrow2BRnfoText"><p className="publicSan">Bathrooms</p></div>
                    </div>

                    <div className="PBHeaderrow2BRnfologonumAndText">
                    <div className="PBHeaderrow2BRnfologoAndnum">
                      <div className="PBHeaderrow2BRnfologo"><IoCarSportOutline /></div>
                      <div className="PBHeaderrow2BRnfonum"><h5>1</h5></div>
                    </div>
                    <div className="PBHeaderrow2BRnfoText"><p className="publicSan">Garages</p></div>
                    </div>

                    <div className="PBHeaderrow2BRnfologonumAndText">
                    <div className="PBHeaderrow2BRnfologoAndnum">
                      <div className="PBHeaderrow2BRnfologo"><TfiRulerAlt2 /></div>
                      <div className="PBHeaderrow2BRnfonum"><h5>2560 <span>Sq Ft</span></h5></div>
                    </div>
                    <div className="PBHeaderrow2BRnfoText"><p className="publicSan">Sqft</p></div>
                    </div>

                    <div className="PBHeaderrow2BRnfologonumAndText">
                    <div className="PBHeaderrow2BRnfologoAndnum">
                      <div className="PBHeaderrow2BRnfologo"><FaRegCalendar /></div>
                      <div className="PBHeaderrow2BRnfonum"><h5>2015</h5></div>
                    </div>
                    <div className="PBHeaderrow2BRnfoText"><p className="publicSan">Year Built</p></div>
                    </div>
                  </div>
                </div>
            </div>

            <div className="PropertyBrainSection">
              <div className="row">
